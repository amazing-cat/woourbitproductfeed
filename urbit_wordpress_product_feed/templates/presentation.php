<div id="urbit-theme-texticon_390" class="urbit-theme__widget urbit-theme-texticon ABdmKOduM6 text-center" style=""
     data-tab-id="intro">
    ...
    <div class="row urbit-theme-texticon__element">
        ...
        <div class="col col-sm-8 col-xs-12">
            ...
            <div class="text b b3">Adding Urb-it as a sales channel for your physical store will move your inventory
                faster as it lower the barrier to purchase. Checking out with urb-it is seamless for customers and
                handover often happens within an hour of purchase.
            </div>
        </div>
    </div>
    <br>
    <div class="row urbit-theme">
        ...
        <div class="col col-sm-8 col-xs-12">
            ...
            <div class="text b b3">Nowadays customers get inspired, shop and share their experience from all possible
                places and platforms; social media, the web, stores etc. Urb-it helps you to meet the exceeding
                expectations for “on demand” shopping this entails, by being accessible when and where they want to be
                inspired, shop, and receive their purchase.
            </div>
        </div>
    </div>
    <br><br>
    <div class="row urbit-theme-texticon__element">
        ...
        <div class="col col-sm-8 col-xs-12">
            ...
            <div class="text b b3">With Urb-it you can be sure that your customer will be treated right. From a smooth,
                hassle-free checkout process to a personal handover of their purchase at a time that suits them best,
                your customer is in good hands.
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row urbit-theme-circle__container">
            <div class="col col-sm-4 text-center urbit-theme-circle__element numerated">
                <div class="image image-small">
                    <img src="{$urbitproductfeed_img_path|escape:'html':'utf-8'}Onboarding_1.gif"
            ...
            <div class="col col-sm-4 text-center urbit-theme-circle__element numerated">
                <div class="image image-small">
                    <img src="{$urbitproductfeed_img_path|escape:'html':'utf-8'}Onboarding_2.gif"
            ...
            <div class="col col-sm-4 text-center urbit-theme-circle__element numerated">
                <div class="image image-small">
                    <img src="{$urbitproductfeed_img_path|escape:'html':'utf-8'}Onboarding_3.gif"
...
<div class="contact-btn text-center">
    <a href="https://addons.prestashop.com/en/contact-us?id_product=29320" target="_blank">
