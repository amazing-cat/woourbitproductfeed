...
if (is_admin()) {
    function load_product_feed_styles($hook)
    {
        ...
        wp_enqueue_script('bootstrap_js', plugins_url('templates/admin/assets/js/bootstrap.bundle.js', __FILE__), array('jquery'));
        wp_enqueue_script('multiselect', plugins_url('templates/admin/assets/js/multiselect.js', __FILE__));
        wp_enqueue_script('config_js', plugins_url('templates/admin/assets/js/config.js', __FILE__), array('jquery', 'multiselect', 'bootstrap_js'));
    }
